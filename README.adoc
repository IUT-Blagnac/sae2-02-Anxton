...
| 4    | link:src/main/java/eraser/EraserCompteur.java[compteur] | Java     | Efficacité
| 5    | link:solution_compteur.c[compteur]                      | C        | Efficacité
| 6    | link:solution_en_place.c[en_place]                      | C        | Sobriété numérique
