...
| 4    | link:src/main/java/eraser/EraserCompteur.java[compteur] WIP | Java     | Efficacité
| 5    | link:solution_compteur.c[compteur]  WIP                    | C        | Efficacité
| 6    | link:solution_en_place.c[en_place]  (ne fonctionne pas)                    | C        | Sobriété numérique
| 7    | link:solution_regex.py[regex]                           | Python   | Simplicité
| 8    | link:solution_suppr.py[suppression]                     | Python   | Simplicité
| 9    | link:solution_ajout.py[ajout]                           | Python   | Simplicité
...
- Pour reproduire mon analyse des algorithmes sur Python :
. Lancez link:analyse.py[analyse.py]
. ...
