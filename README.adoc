...
| 2    | link:src/main/java/eraser/EraserRegex.java[regex]       | Java     | Efficacité
| 3    | link:solution_compteur.py[compteur]                     | C        | Efficacité
| 4    | link:solution_en_place.c[en_place]                      | C        | Sobriété numérique
| 5    | link:solution_regex.py[regex]                           | Python   | Simplicité
| 6    | link:solution_compteur.py[compteur]                     | Python   | Efficacité
| 7    | link:src/main/java/eraser/EraserCompteur.java[compteur] | Java     | Efficacité
