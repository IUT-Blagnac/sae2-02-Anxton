...
| 1    | link:solution_regex.py[regex]                           | Python   | Efficacité
| 2    | link:solution_compteur.py[compteur]                     | Python   | Efficacité
| 3    | link:src/main/java/eraser/EraserRegex.java[regex]       | Java     | Efficacité
| 5    | link:solution_en_place.c[en_place]  (ne fonctionne pas)                    | C        | Sobriété numérique
| 6    | link:solution_regex.py[regex]                           | Python   | Simplicité
| 7    | link:solution_suppr.py[suppression]                     | Python   | Simplicité
| 8    | link:solution_ajout.py[ajout]                           | Python   | Simplicité
| 997  | link:solution_comprehension.py[compréhension]           | Python   | Expérimental      
| 998  | link:solution_recursif.py[recursif]                     | Python   | Expérimental      
| 999  | link:solution_while.py[while]                           | Python   | Expérimental      
|==========================================================================
...
- Pour reproduire mes vérifications des algorithmes :
. Lancez link:analyse/verification.py[ma vérification Python]
. Lancez link:analyse/Verification.java[ma vérification Java]
. Lancez link:analyse/verification.c[ma vérification C] : +
    `gcc .\verification.c .\algos\sobriete76.c -o verification` +
    `.\verification.exe`

- Pour reproduire mon analyse des efficacités des algorithmes Java :
. Lancez link:analyse/Analyse.java[mon analyse Java]

=== Rapports

link:rapport/rapport_efficacite.adoc[Catégorie efficacité] +
link:rapport/rapport_simplicite.adoc[Catégorie simplicité] +
link:rapport/rapport_sobriete.adoc[Catégorie sobriété]
